...
public class ProductDto {
    ...
    private String category;    //카테고리  -> 선택박스

    @NotBlank(message = "카테고리 세부사항을 입력해 주세요.")
    ...
    private String material;    //주요 소재  -> 그냥 적기 ex) LPM, PB, 데코시트
    ...
    private int price;          //정가    -> 숫자만 적을수있도록
    ...
    public ProductDto(String name, String category, String categoryDetail, String color, String material, String size, String origin, String ASPhone, String detail, int price, int stock) {
        this.name = name;
    ...
    public ProductDto(Product product) {
        ...
        this.categoryDetail = product.getCategoryDetail();
