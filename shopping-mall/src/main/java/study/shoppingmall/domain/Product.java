...
public class Product extends BaseEntity {
    ...
    @Column(name = "product_category_detail")
    private String categoryDetail;  //카테고리 세부사항
...
//    private List<CategoryProduct> categories = new ArrayList<>();
    ...
    protected void setCategoryDetail(String categoryDetail) {
    ...
    public Product(ProductDto productDto) {
        ...
        this.categoryDetail = productDto.getCategoryDetail();
    ...
    public void changeProduct(String name, String category, String categoryDetail, String color, String material, String size, String origin, String detail, String ASPhone, int price, int stock) {
        this.setName(name);
        this.setCategory(category);
        this.setCategoryDetail(categoryDetail);
        this.setColor(color);
    ...
    public void addComment(int rating) {
        this.rating = (int)((this.review * this.rating)+rating)/(this.review+1);
